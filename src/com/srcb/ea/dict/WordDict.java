...
public class WordDict {
	...
	static String featureDictPath = Config.DICT_PATH + "feature.txt";

	static String negDictPath = Config.DICT_PATH + "negative.txt";

	static String posDictPath = Config.DICT_PATH + "positive.txt";

	static String stopDictPath = Config.DICT_PATH + "aspect_stop.jd";
